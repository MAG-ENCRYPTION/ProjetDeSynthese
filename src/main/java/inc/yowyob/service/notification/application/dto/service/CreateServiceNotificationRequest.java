...
@Data
public class CreateServiceNotificationRequest {

    @NotBlank(message = "The service is required")
    @Size(max = 30, message = "The service name must be at least 30 characters ")
